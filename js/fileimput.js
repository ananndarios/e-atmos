...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div tabindex="500" class="form-control file-caption {class}">\n' +
                '   <div class="file-caption-name">Clique neste botão ao lado --></div>\n' +
                '</div>\n';
    ...
    $.fn.fileinputLocales.en = {
        ...
        //dropZoneTitle: 'ARRASTE SEU <span style="color: black!important"><strong> CURRICULO </strong></span> <br /> WORD, PDF OU IMAGEM &hellip;',
        dropZoneTitle: 'Clique no Botão Azul PROCURAR e envie seu CURRÍCULO <br /> em WORD, PDF OU IMAGEM &hellip;',
